...
class Hotel(Base):
    ...
    accessibility_features: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False
    )
    has_balcony: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    free_wifi: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    has_cribs: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    pet_friendly: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    smoke_free: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    has_pool: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    has_laundry: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    free_breakfast: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    airport_shuttle: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False
    )
...
class Booking(Base):
    ...
    booking_status: Mapped[str] = mapped_column(
        String(20), nullable=False, default=BookingStatus.confirmed
    )
...
class ExperienceRequest(Base):
    ...
    experience_id: Mapped[int] = mapped_column(
        ForeignKey("experiences.id"), nullable=False
    )
    user_id: Mapped[int] = mapped_column(ForeignKey("users.id"), nullable=False)
